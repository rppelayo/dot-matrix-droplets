/* Dot Matrix Droplets
   ...
   Requires: MPU6050 library by Jeff Rowberg
             LEDMatrixDriver library by Bartosz Bielawski

   Tutorial: https://www.teachmemicro.com/led-dot-matrix-droplets

   v1.0 - June 18, 2020
        - Initial Commit
        - ToDo: add gravity/momentum for smoother movements
*/
